                ...
                <div class="col-lg-12 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                                ...
                                if (request.getParameter("aluno") != null && request.getParameter("prof") != null
                                    ...
                                    if (Alterar.alterarPerfil(aluno, aluno2) && Alterar.alterarPerfil(professor, professor2)
                                        ...
                                        <div class="alert alert-success">
                                            <strong>Todas as alterações foram realizadas!</strong>
                                        </div>
                                        <%
                                        ...
                                        <div class="alert alert-danger">
                                            <strong>Alguma alteração não foi realizada!</strong>
                                        </div>
                                        <%
                                    }
                                    

                                    aluno = Visualizar.getPerfil(TipoPerfil.ALUNO);
                                    residente = Visualizar.getPerfil(TipoPerfil.RESIDENTE);
                                    isento = Visualizar.getPerfil(TipoPerfil.ISENTO);
                                    professor = Visualizar.getPerfil(TipoPerfil.PROFESSOR);
                                    servidor = Visualizar.getPerfil(TipoPerfil.SERVIDOR);
                                    autorizado = Visualizar.getPerfil(TipoPerfil.AUTORIZADO);
                                }
                            ...
                            <center>
                                <form action="Administrador?comando=AlterarPreco" method="post">
                                    <div class="form-row">
                                        <div class="col-md-4 form-group">
                                            <label> Aluno </label>
                                            <input min="0.0" type="number" step="0.1" value="<%= aluno.getValor()%>" name="aluno" required="" class="form-control">
                                        </div> <!-- form-group end.// -->

                                        <div class="col-md-4 form-group">
                                            <label> Professor </label>
                                            <input min="0.0" type="number" step="0.1" value="<%= professor.getValor()%>" name="prof" required="" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->

                                        <div class="col-md-4 form-group">
                                            <label> Servidor </label>
                                            <input min="0.0" type="number" step="0.1" value="<%= servidor.getValor()%>" name="serv" required="" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->
                                    </div> <!-- form-row end.// -->
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input min="0.0" type="number" step="0.1" value="<%= residente.getValor()%>" name="resid" required="" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->

                                        <div class="col-md-4 form-group">
                                            <label> Isento </label>
                                            <input min="0.0" type="number" step="0.1" value="<%= isento.getValor()%>" name="isento" required="" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->

                                        <div class="col-md-4 form-group">
                                            <label> Autorizado </label>
                                            <input min="0.0" type="number" step="0.1" value="<%= autorizado.getValor()%>" name="auto" required="" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->
                                    </div> <!-- form-row end.// -->

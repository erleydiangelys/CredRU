                    ...
                    <div class="col-md-8 mb-5" >
                        <div class="card">
                            <header class="card-header">
                                <center>
                                    <h4 class="card-title mt-2">Cadastrar Novo Alimento</h4>
                                </center>
                            </header>
                            <%
                                ...
                                <form action="Nutricionista?comando=CadastrarAlimento" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="number" name="valorC" value="0" min="0" step="0.01" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->

                                        <div class="col-md-3 form-group">
                                            <label> Total de gramas (g)</label>
                                            <input type="number" name="valorG" value="0" min="0" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->
                                    </div> <!-- form-row end.// -->
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="number" name="calCarboidrato" value="0" min="0" step="0.01" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->

                                        <div class="col-md-4 form-group">
                                            <label>Proteínas (cal) </label>
                                            <input type="number" name="calProteina" value="0" min="0" step="0.01" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->

                                        <div class="col-md-4 form-group">
                                            <label> Lipídios (cal) </label>
                                            <input type="number" name="calLipidio" value="0" min="0" step="0.01" class="form-control" placeholder=" ">
                                        </div> <!-- form-group end.// -->
                                    </div> <!-- form-row end.// -->

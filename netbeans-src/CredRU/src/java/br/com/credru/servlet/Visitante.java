...
public class Visitante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Comando pagina = new PaginaNaoEncontrada();
        
	try {
            if(request.getParameter("comando") == null || request.getParameter("comando").isEmpty()){
                pagina = new Inicio();
            }
            else{
		...
		e.printStackTrace();
            ...
            pagina.execute(request, response);
        }
    }
